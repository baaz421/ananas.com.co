                ...
                <div class="product product-7 text-center">
                    <figure class="product-media">
                        ...
                        <div class="product-action">
                            <?php  ?>
                            <a href="#" class="btn-product btn-cart <?php echo $buttom_cart_disable; ?>" id="cart-buttom-<?php echo $w_id; ?>" data-pro_id="<?php echo $pro_id; ?>" >
                                <span>add to cart</span>
                            </a>
...
$(document).on("click","#add-to-cart, #add-to-cart-qview",function(ca){
    if(this.id == "add-to-cart"){
        ...
        var p_id = $("#p-id").val();
        var user_id = $("#u-id").val();
        AddToCartProductView(button,p_id,user_id);
        }   
...
$("#cart-buttom-1").click(function(wb){
    if($(this).hasClass("isDisabled")){
        ...
        var p_id_b = $(this).data("pro_id");
        var user_id_b = $("#u-id").val();
        AddToCartProductView(button_b,p_id_b,user_id_b);
    }
    wb.preventDefault();
});
...
function AddToCartProductView(bc_button,Product_ID,User_ID){
