...
if($_SESSION['u_email'] == false){
  header('Location: http://localhost/molla/main-app/login.php');
 // if(mysql_num_rows($query)==0) { echo '<meta http-equiv="refresh" content="0; url=http://localhost/molla/main-app/login.php">'; die(); }
}
?>
