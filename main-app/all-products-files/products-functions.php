    ...
    <div class="product">
        <figure class="product-media">
            ...
            <div class="product-action action-icon-top">
                <a href="#" class="btn-product btn-cart '.$c_disable.'" id="add-to-cart" data-p_id="'.$p_id.'" data-d_id="'.$deal_id.'"><span>Cart</span></a>
                <a href="'.$link.'" class="btn-product btn-quickview" id="quickView" title="Quick view"><span>quick view</span></a>
            </div>
        </figure>
