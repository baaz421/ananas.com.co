					...
					<div class="product-right">
						<div class="owl-carousel owl-theme owl-nav-inside owl-light mb-0" data-toggle="owl" data-owl-options='{
							...
							<div class="intro-slide" data-hash="one">
	                            <img src="assets/images/products/single/fullwidth/1-big.jpg" id="product-zoom" data-zoom-image="assets/images/products/single/fullwidth/1-big.jpg" alt="Image Desc">
		                    </div><!-- End .intro-slide -->
