...
if($_SESSION['email'] == false){
  header('Location: http://localhost/molla/app/login.php');
												...
												if($email != false && $password != false){
											    	...
											    	$run_Sql = mysqli_query($con, $sql);
												    	...
												    	if($run_Sql){
												        	...
												        	$status = $fetch_info['vstatus'];
												        	
												        	$code = $fetch_info['vcode'];
											        	if($status == "verified"){
											            	if($code != 0){
																header('location: http://localhost/molla/app/rest_code.php');
									            				}
									        				}else{
											?>
									        <div class="row">
				                					<div class="col-sm-6">
					                					...
					                					<button type="submit" class="btn btn-outline-primary-2" name="check">
					                					<span>Submit</span>
